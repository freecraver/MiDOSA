;(function(undefined) {
  ...
  var drawChart = function(node,x,y,size, context) {
      //var ctx = document.getElementById('overview_graph_container').getElementsByClassName('sigma-scene')[0].getContext('2d');
  ...
  var register = function(name,drawShape,drawBorder) {
    sigma.canvas.nodes[name] = function(node, context, settings) {
      ...
      //drawChart(node,x,y,size,context);
